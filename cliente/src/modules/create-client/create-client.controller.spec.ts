...
const MockedCreateClientUseCase = CreateClientUseCase as unknown as ReturnType<typeof vi.fn>;
...
describe('CreateCustomerController', () => {
  ...
  it('should return 201 and the created client on success', async () => {
    ...
    expect(MockedCreateClientUseCase.prototype.execute).toHaveBeenCalledWith(clientData);
